...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Avanzar periodo <small><?= "$periodo->id, $periodo->carrera - $periodo->sede ($periodo->estructura)"; ?></small></h1>
	</div>
</div>

<div class="row">
	<div class="col-lg-12">
		<form name="sede" method="POST" action="moduloPlanificacion/Periodo/guardarAvanzar.php" data-exe="embem('moduloPlanificacion/Periodo/index.php', '#page-wrapper')" role="form">
			<div class="form-group">
				<input type="text" name="id" placeholder="Nuevo código" class="form-control" pattern="^[A-ZÁÉÍÓÚÑ0-9\-]+$" required="required" />
