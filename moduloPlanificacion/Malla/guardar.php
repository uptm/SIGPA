...
// Si se guardo la malla correctamente
	...
	// Agregar elemento al registro de acciones realizadas
		...
		$sql = "insert into historial values('" . time() . "', '$_SESSION[nombre] $_SESSION[apellido] ($_SESSION[cedula])', 'Se agregó la malla <strong>$id</strong>', '" . htmlspecialchars($sql, ENT_QUOTES) . "')";
		$exe = pg_query($sigpa, $sql);
